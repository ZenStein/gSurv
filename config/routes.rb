Myapp::Application.routes.draw do
 ...
 # root to: 'dashboards#dashboard_1'
  root to: 'appviews#clients'


  get 'exit',        to: 'sessions#leave',       as: :leave
  get 'home',        to: 'sessions#home',        as: :home
  get 'profile',     to: 'sessions#profile',     as: :profile
  get 'register',     to: 'sessions#register'#,    #as: :register
  get 'auth_flow',    to: 'sessions#auth_flow',    as: :auth_flow
  post 'pages/authenticate', to: 'sessions#authenticate'
